...
{
  by-spec."JSONStream"."0.8.0" =
    self.by-version."JSONStream"."0.8.0";
  by-version."JSONStream"."0.8.0" = lib.makeOverridable self.buildNodePackage {
    name = "node-JSONStream-0.8.0";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/JSONStream/-/JSONStream-0.8.0.tgz";
        name = "JSONStream-0.8.0.tgz";
        sha1 = "efc462d5a5bc94ec007f4b22571acd7f6f2ae013";
      })
    ];
    buildInputs =
  ...
  by-spec."addressparser"."^0.3.1" =
    self.by-version."addressparser"."0.3.1";
  by-version."addressparser"."0.3.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-addressparser-0.3.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/addressparser/-/addressparser-0.3.1.tgz";
        name = "addressparser-0.3.1.tgz";
        sha1 = "f9c44caa6c882b54855e8ae324c2d51e541bded4";
      })
    ];
    buildInputs =
  ...
  by-spec."ax"."0.1.8" =
    self.by-version."ax"."0.1.8";
  by-version."ax"."0.1.8" = lib.makeOverridable self.buildNodePackage {
    name = "node-ax-0.1.8";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/ax/-/ax-0.1.8.tgz";
        name = "ax-0.1.8.tgz";
        sha1 = "27ca9a73fa4c78a478d62d827cad860a24fdd497";
      })
    ];
    buildInputs =
      (self.nativeDeps."ax" or []);
    deps = [
    ];
    peerDependencies = [
    ];
  ...
  by-spec."bluebird"."~2.2.1" =
    self.by-version."bluebird"."2.2.2";
  by-version."bluebird"."2.2.2" = lib.makeOverridable self.buildNodePackage {
    name = "node-bluebird-2.2.2";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/bluebird/-/bluebird-2.2.2.tgz";
        name = "bluebird-2.2.2.tgz";
        sha1 = "f1bf05abc887cf9a703886237c28610a43b1f114";
      })
    ];
    buildInputs =
  ...
  by-spec."btoa"."1.1.1" =
    self.by-version."btoa"."1.1.1";
  by-version."btoa"."1.1.1" = lib.makeOverridable self.buildNodePackage {
    name = "btoa-1.1.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/btoa/-/btoa-1.1.1.tgz";
        name = "btoa-1.1.1.tgz";
        sha1 = "27c8106263108e9dd41ff2faaad2a17045e35eba";
      })
    ];
    buildInputs =
      (self.nativeDeps."btoa" or []);
    deps = [
    ];
    peerDependencies = [
    ];
  ...
  by-spec."buildmail"."^0.1.11" =
    self.by-version."buildmail"."0.1.11";
  by-version."buildmail"."0.1.11" = lib.makeOverridable self.buildNodePackage {
    name = "node-buildmail-0.1.11";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/buildmail/-/buildmail-0.1.11.tgz";
        name = "buildmail-0.1.11.tgz";
        sha1 = "d833044e2635d9a886bdbbeb49f0055c18624a64";
      })
    ];
    buildInputs =
      (self.nativeDeps."buildmail" or []);
    deps = [
      self.by-version."addressparser"."0.3.1"
      self.by-version."hyperquest"."0.3.0"
      self.by-version."libbase64"."0.1.0"
      self.by-version."libmime"."0.1.3"
      self.by-version."libqp"."0.1.1"
    ];
    peerDependencies = [
    ];
    passthru.names = [ "buildmail" ];
  };
  by-spec."bytes"."1" =
    self.by-version."bytes"."1.0.0";
  ...
  by-spec."bytes"."1.0.0" =
    self.by-version."bytes"."1.0.0";
  by-spec."canonical-json"."0.0.4" =
    self.by-version."canonical-json"."0.0.4";
  by-version."canonical-json"."0.0.4" = lib.makeOverridable self.buildNodePackage {
    name = "node-canonical-json-0.0.4";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/canonical-json/-/canonical-json-0.0.4.tgz";
        name = "canonical-json-0.0.4.tgz";
        sha1 = "6579c072c3db5c477ec41dc978fbf2b8f41074a3";
      })
    ];
    buildInputs =
      (self.nativeDeps."canonical-json" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "canonical-json" ];
  };
  by-spec."chalk"."~0.5.1" =
  ...
  "compression" = self.by-version."compression"."1.0.11";
  ...
  by-spec."cookie-parser"."~1.3.2" =
    self.by-version."cookie-parser"."1.3.2";
  "cookie-parser" = self.by-version."cookie-parser"."1.3.2";
  ...
  by-spec."cookiejar"."1.3.1" =
    self.by-version."cookiejar"."1.3.1";
  by-version."cookiejar"."1.3.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-cookiejar-1.3.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/cookiejar/-/cookiejar-1.3.1.tgz";
        name = "cookiejar-1.3.1.tgz";
        sha1 = "c04b048f688f801623acd90cd5848c2bf8891a17";
      })
    ];
    buildInputs =
  ...
  by-spec."cors"."~2.4.1" =
    self.by-version."cors"."2.4.1";
  by-version."cors"."2.4.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-cors-2.4.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/cors/-/cors-2.4.1.tgz";
        name = "cors-2.4.1.tgz";
        sha1 = "b09c049a7ac8d5a8f757d9a4162b6dab51621581";
      })
    ];
    buildInputs =
      (self.nativeDeps."cors" or []);
    deps = [
    ];
    peerDependencies = [
    ];
  ...
  by-spec."csurf"."~1.4.0" =
    self.by-version."csurf"."1.4.1";
  by-version."csurf"."1.4.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-csurf-1.4.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/csurf/-/csurf-1.4.1.tgz";
        name = "csurf-1.4.1.tgz";
  ...
  by-spec."domready"."~1.0.5" =
    self.by-version."domready"."1.0.6";
  by-version."domready"."1.0.6" = lib.makeOverridable self.buildNodePackage {
    name = "node-domready-1.0.6";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/domready/-/domready-1.0.6.tgz";
        name = "domready-1.0.6.tgz";
        sha1 = "126e86270d407d5304ef759a86a4f268d3de7a19";
      })
    ];
    buildInputs =
      (self.nativeDeps."domready" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "domready" ];
  };
  "domready" = self.by-version."domready"."1.0.6";
  ...
  by-spec."ejs"."~1.0.0" =
    self.by-version."ejs"."1.0.0";
  by-version."ejs"."1.0.0" = lib.makeOverridable self.buildNodePackage {
    name = "node-ejs-1.0.0";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/ejs/-/ejs-1.0.0.tgz";
        name = "ejs-1.0.0.tgz";
  ...
  by-spec."elasticsearch"."~2.4.0" =
    self.by-version."elasticsearch"."2.4.0";
  by-version."elasticsearch"."2.4.0" = lib.makeOverridable self.buildNodePackage {
    name = "node-elasticsearch-2.4.0";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/elasticsearch/-/elasticsearch-2.4.0.tgz";
        name = "elasticsearch-2.4.0.tgz";
        sha1 = "b6bb2305be96cc56cb1cc8494746b7af7619e2b4";
      })
    ];
    buildInputs =
      (self.nativeDeps."elasticsearch" or []);
    deps = [
      self.by-version."bluebird"."2.2.2"
      self.by-version."chalk"."0.5.1"
    ...
    passthru.names = [ "elasticsearch" ];
  };
  "elasticsearch" = self.by-version."elasticsearch"."2.4.0";
  ...
  by-spec."errorhandler"."^1.1.1" =
    self.by-version."errorhandler"."1.1.1";
  "errorhandler" = self.by-version."errorhandler"."1.1.1";
  by-spec."errs"."0.2.x" =
  ...
  by-spec."filed"."0.0.7" =
    self.by-version."filed"."0.0.7";
  by-version."filed"."0.0.7" = lib.makeOverridable self.buildNodePackage {
    name = "node-filed-0.0.7";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/filed/-/filed-0.0.7.tgz";
        name = "filed-0.0.7.tgz";
        sha1 = "3087ec531fb9a78600a6ec8e0b106e2c574d9773";
      })
    ];
    buildInputs =
      (self.nativeDeps."filed" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "filed" ];
  };
  ...
  by-spec."hyperquest"."^0.3.0" =
    self.by-version."hyperquest"."0.3.0";
  by-version."hyperquest"."0.3.0" = lib.makeOverridable self.buildNodePackage {
    name = "node-hyperquest-0.3.0";
    src = [
      (fetchurl {
  ...
  by-spec."iconv-lite".">= 0.1.2" =
    self.by-version."iconv-lite"."0.4.4";
  by-spec."iconv-lite"."^0.4.0" =
    self.by-version."iconv-lite"."0.4.4";
  by-spec."inflection"."~1.3.8" =
    self.by-version."inflection"."1.3.8";
  by-version."inflection"."1.3.8" = lib.makeOverridable self.buildNodePackage {
    name = "node-inflection-1.3.8";
    src = [
      (fetchurl {
  ...
  by-spec."inherits"."~2.0.1" =
    self.by-version."inherits"."2.0.1";
  by-spec."ip"."0.0.x" =
    self.by-version."ip"."0.0.5";
  by-version."ip"."0.0.5" = lib.makeOverridable self.buildNodePackage {
    name = "node-ip-0.0.5";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/ip/-/ip-0.0.5.tgz";
        name = "ip-0.0.5.tgz";
        sha1 = "0b405f761a565e2af045cba09854e484dca97706";
      })
    ];
    buildInputs =
  ...
  by-spec."jayson"."~1.1.1" =
    self.by-version."jayson"."1.1.1";
  by-version."jayson"."1.1.1" = lib.makeOverridable self.buildNodePackage {
    name = "jayson-1.1.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/jayson/-/jayson-1.1.1.tgz";
        name = "jayson-1.1.1.tgz";
        sha1 = "41ba1c49b6aa50cbb873ba3f511c94d42c56b825";
      })
    ];
    buildInputs =
      (self.nativeDeps."jayson" or []);
    deps = [
      self.by-version."JSONStream"."0.8.0"
      self.by-version."commander"."1.3.2"
      self.by-version."eyes"."0.1.8"
  ...
  by-version."json-stringify-safe"."4.0.0" = lib.makeOverridable self.buildNodePackage {
    name = "node-json-stringify-safe-4.0.0";
    src = [
      (fetchurl {
  ...
  by-spec."less"."~1.4.2" =
    self.by-version."less"."1.4.2";
  by-version."less"."1.4.2" = lib.makeOverridable self.buildNodePackage {
    name = "less-1.4.2";
    src = [
      (fetchurl {
  ...
  by-spec."libbase64"."^0.1.0" =
    self.by-version."libbase64"."0.1.0";
  by-version."libbase64"."0.1.0" = lib.makeOverridable self.buildNodePackage {
    name = "node-libbase64-0.1.0";
    src = [
      (fetchurl {
    ...
    buildInputs =
      (self.nativeDeps."libbase64" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "libbase64" ];
  };
  by-spec."libmime"."^0.1.2" =
    self.by-version."libmime"."0.1.3";
  by-version."libmime"."0.1.3" = lib.makeOverridable self.buildNodePackage {
    name = "node-libmime-0.1.3";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/libmime/-/libmime-0.1.3.tgz";
        name = "libmime-0.1.3.tgz";
        sha1 = "a726019dd608b84c353f7bf148004f5c07e819a7";
      })
    ];
    buildInputs =
      (self.nativeDeps."libmime" or []);
    deps = [
      self.by-version."iconv-lite"."0.4.4"
      self.by-version."libbase64"."0.1.0"
      self.by-version."libqp"."0.1.1"
    ...
    passthru.names = [ "libmime" ];
  };
  by-spec."libqp"."^0.1.1" =
    self.by-version."libqp"."0.1.1";
  by-version."libqp"."0.1.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-libqp-0.1.1";
    src = [
      (fetchurl {
    ...
    buildInputs =
      (self.nativeDeps."libqp" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "libqp" ];
  };
  by-spec."lodash-node"."~2.4" =
    self.by-version."lodash-node"."2.4.1";
  ...
  by-spec."lodash._baseclone"."~2.4.1" =
    self.by-version."lodash._baseclone"."2.4.1";
  by-version."lodash._baseclone"."2.4.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-lodash._baseclone-2.4.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/lodash._baseclone/-/lodash._baseclone-2.4.1.tgz";
        name = "lodash._baseclone-2.4.1.tgz";
        sha1 = "30f823e57e17e3735d383bd62b60b387543b4186";
      })
    ];
    buildInputs =
      (self.nativeDeps."lodash._baseclone" or []);
    deps = [
      self.by-version."lodash.assign"."2.4.1"
      self.by-version."lodash.foreach"."2.4.1"
      self.by-version."lodash.forown"."2.4.1"
      self.by-version."lodash._getarray"."2.4.1"
      self.by-version."lodash.isarray"."2.4.1"
      self.by-version."lodash.isobject"."2.4.1"
    ...
    passthru.names = [ "lodash._baseclone" ];
  };
  ...
  by-spec."lodash.clonedeep"."^2.4.1" =
    self.by-version."lodash.clonedeep"."2.4.1";
  by-version."lodash.clonedeep"."2.4.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-lodash.clonedeep-2.4.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/lodash.clonedeep/-/lodash.clonedeep-2.4.1.tgz";
        name = "lodash.clonedeep-2.4.1.tgz";
        sha1 = "f29203b40b12fee0a45d3631648259bebabc7868";
      })
    ];
    buildInputs =
      (self.nativeDeps."lodash.clonedeep" or []);
    deps = [
      self.by-version."lodash._baseclone"."2.4.1"
      self.by-version."lodash._basecreatecallback"."2.4.1"
    ];
    ...
    passthru.names = [ "lodash.clonedeep" ];
  };
  ...
  by-spec."lodash.foreach"."~2.4.1" =
    self.by-version."lodash.foreach"."2.4.1";
  by-version."lodash.foreach"."2.4.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-lodash.foreach-2.4.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/lodash.foreach/-/lodash.foreach-2.4.1.tgz";
        name = "lodash.foreach-2.4.1.tgz";
        sha1 = "fe3fc3a34c86c94cab6f9522560282741e016309";
      })
    ];
    buildInputs =
      (self.nativeDeps."lodash.foreach" or []);
    deps = [
      self.by-version."lodash._basecreatecallback"."2.4.1"
      self.by-version."lodash.forown"."2.4.1"
    ];
    ...
    passthru.names = [ "lodash.foreach" ];
  };
  by-spec."lodash.forown"."~2.4.1" =
    self.by-version."lodash.forown"."2.4.1";
  by-version."lodash.forown"."2.4.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-lodash.forown-2.4.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/lodash.forown/-/lodash.forown-2.4.1.tgz";
        name = "lodash.forown-2.4.1.tgz";
        sha1 = "78b41eafe1405fa966459ea4193fd502d084524b";
      })
    ];
    buildInputs =
      (self.nativeDeps."lodash.forown" or []);
    deps = [
      self.by-version."lodash._basecreatecallback"."2.4.1"
      self.by-version."lodash.keys"."2.4.1"
      self.by-version."lodash._objecttypes"."2.4.1"
  ...
  by-spec."lodash.isarray"."~2.4.1" =
    self.by-version."lodash.isarray"."2.4.1";
  by-version."lodash.isarray"."2.4.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-lodash.isarray-2.4.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/lodash.isarray/-/lodash.isarray-2.4.1.tgz";
        name = "lodash.isarray-2.4.1.tgz";
        sha1 = "b52a326c1f62f6d7da73a31d5401df6ef44f0fa1";
      })
    ];
    buildInputs =
      (self.nativeDeps."lodash.isarray" or []);
    deps = [
      self.by-version."lodash._isnative"."2.4.1"
    ];
    peerDependencies = [
    ];
    passthru.names = [ "lodash.isarray" ];
  };
  ...
  by-spec."loopback"."git://github.com/offlinehacker/loopback.git#master" =
    self.by-version."loopback"."2.1.3";
  by-version."loopback"."2.1.3" = lib.makeOverridable self.buildNodePackage {
    name = "node-loopback-2.1.3";
    src = [
      (fetchgit {
        url = "git://github.com/offlinehacker/loopback.git";
        rev = "f9d60ecec2d8866badb04128e351b3a7e936462f";
        sha256 = "3d79726be8a5e14d285d1a0eb5c3533924e2168059f3032c7c6d393a3a6d3c1f";
      })
    ];
    buildInputs =
      (self.nativeDeps."loopback" or []);
    deps = [
      self.by-version."async"."0.9.0"
      self.by-version."body-parser"."1.4.3"
      self.by-version."canonical-json"."0.0.4"
      self.by-version."ejs"."1.0.0"
      self.by-version."express"."4.8.5"
      self.by-version."strong-remoting"."2.0.5"
      self.by-version."bcryptjs"."2.0.2"
      self.by-version."debug"."1.0.4"
      self.by-version."inflection"."1.3.8"
      self.by-version."nodemailer"."1.0.4"
      self.by-version."nodemailer-stub-transport"."0.1.4"
      self.by-version."uid2"."0.0.3"
      self.by-version."underscore"."1.6.0"
      self.by-version."underscore.string"."2.3.3"
    ];
    peerDependencies = [
      self.by-version."loopback-datasource-juggler"."2.5.2"
    ];
    passthru.names = [ "loopback" ];
  };
  "loopback" = self.by-version."loopback"."2.1.3";
  by-spec."loopback-boot"."git://github.com/matejc/loopback-boot.git#master" =
    self.by-version."loopback-boot"."2.0.0";
  by-version."loopback-boot"."2.0.0" = lib.makeOverridable self.buildNodePackage {
    name = "node-loopback-boot-2.0.0";
    src = [
      (fetchgit {
        url = "git://github.com/matejc/loopback-boot.git";
        rev = "4c88a5dba91a73642eed0c06beb4e8fc2e97437a";
        sha256 = "2395d46cc335088f05deedfb7c206a1915d35216418bbc7ae876875949d107d4";
      })
    ];
    buildInputs =
      (self.nativeDeps."loopback-boot" or []);
    deps = [
      self.by-version."commondir"."0.0.1"
      self.by-version."debug"."1.0.4"
      self.by-version."lodash.clonedeep"."2.4.1"
      self.by-version."semver"."2.3.2"
      self.by-version."toposort"."0.2.10"
      self.by-version."underscore"."1.6.0"
    ];
    peerDependencies = [
    ];
    passthru.names = [ "loopback-boot" ];
  };
  "loopback-boot" = self.by-version."loopback-boot"."2.0.0";
  by-spec."loopback-component-storage"."~1.0.5" =
    self.by-version."loopback-component-storage"."1.0.5";
  by-version."loopback-component-storage"."1.0.5" = lib.makeOverridable self.buildNodePackage {
    name = "node-loopback-component-storage-1.0.5";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/loopback-component-storage/-/loopback-component-storage-1.0.5.tgz";
        name = "loopback-component-storage-1.0.5.tgz";
        sha1 = "3c200fb620cef1b66fa254eb99fb204b2cc0ffc5";
      })
    ];
    buildInputs =
      (self.nativeDeps."loopback-component-storage" or []);
    deps = [
      self.by-version."pkgcloud"."0.9.6"
      self.by-version."async"."0.9.0"
      self.by-version."formidable"."1.0.15"
    ];
    peerDependencies = [
    ];
    passthru.names = [ "loopback-component-storage" ];
  };
  "loopback-component-storage" = self.by-version."loopback-component-storage"."1.0.5";
  by-spec."loopback-connector"."1.x" =
    self.by-version."loopback-connector"."1.1.1";
  by-version."loopback-connector"."1.1.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-loopback-connector-1.1.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/loopback-connector/-/loopback-connector-1.1.1.tgz";
        name = "loopback-connector-1.1.1.tgz";
        sha1 = "2c9f8a3e1b407c3e37a07e7e9e5e457549628019";
      })
    ];
    buildInputs =
      (self.nativeDeps."loopback-connector" or []);
    deps = [
      self.by-version."async"."0.9.0"
    ];
    peerDependencies = [
    ];
    passthru.names = [ "loopback-connector" ];
  };
  by-spec."loopback-datasource-juggler"."^2.0.0" =
    self.by-version."loopback-datasource-juggler"."2.5.2";
  by-version."loopback-datasource-juggler"."2.5.2" = lib.makeOverridable self.buildNodePackage {
    name = "node-loopback-datasource-juggler-2.5.2";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/loopback-datasource-juggler/-/loopback-datasource-juggler-2.5.2.tgz";
        name = "loopback-datasource-juggler-2.5.2.tgz";
        sha1 = "b4445e2643182459ad83f495d56fd57c354f8d96";
      })
    ];
    buildInputs =
      (self.nativeDeps."loopback-datasource-juggler" or []);
    deps = [
      self.by-version."async"."0.9.0"
      self.by-version."debug"."1.0.4"
      self.by-version."inflection"."1.3.8"
    ...
    passthru.names = [ "loopback-datasource-juggler" ];
  };
  by-spec."loopback-explorer"."~1.2.9" =
    self.by-version."loopback-explorer"."1.2.9";
  by-version."loopback-explorer"."1.2.9" = lib.makeOverridable self.buildNodePackage {
    name = "node-loopback-explorer-1.2.9";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/loopback-explorer/-/loopback-explorer-1.2.9.tgz";
        name = "loopback-explorer-1.2.9.tgz";
        sha1 = "dfeac54c7a8dd7af560512bd3c5f6429ed0efb3f";
      })
    ];
    buildInputs =
      (self.nativeDeps."loopback-explorer" or []);
    deps = [
      self.by-version."swagger-ui"."2.0.22"
      self.by-version."debug"."1.0.4"
      self.by-version."lodash.clonedeep"."2.4.1"
      self.by-version."lodash.defaults"."2.4.1"
      self.by-version."express"."3.16.7"
    ...
    passthru.names = [ "loopback-explorer" ];
  };
  "loopback-explorer" = self.by-version."loopback-explorer"."1.2.9";
  by-spec."lru-cache"."2" =
  ...
  "morgan" = self.by-version."morgan"."1.2.3";
  ...
  by-spec."nodemailer"."~1.0.1" =
    self.by-version."nodemailer"."1.0.4";
  by-version."nodemailer"."1.0.4" = lib.makeOverridable self.buildNodePackage {
    name = "node-nodemailer-1.0.4";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/nodemailer/-/nodemailer-1.0.4.tgz";
        name = "nodemailer-1.0.4.tgz";
        sha1 = "a4e6c092f96364aa1e2f8c70005dad9c98097cef";
      })
    ];
    buildInputs =
    ...
    deps = [
      self.by-version."buildmail"."0.1.11"
      self.by-version."libmime"."0.1.3"
      self.by-version."nodemailer-direct-transport"."0.1.2"
      self.by-version."nodemailer-smtp-transport"."0.1.12"
    ];
    peerDependencies = [
    ];
    passthru.names = [ "nodemailer" ];
  };
  by-spec."nodemailer-direct-transport"."^0.1.1" =
    self.by-version."nodemailer-direct-transport"."0.1.2";
  by-version."nodemailer-direct-transport"."0.1.2" = lib.makeOverridable self.buildNodePackage {
    name = "node-nodemailer-direct-transport-0.1.2";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/nodemailer-direct-transport/-/nodemailer-direct-transport-0.1.2.tgz";
        name = "nodemailer-direct-transport-0.1.2.tgz";
        sha1 = "aba8be9b48049e62d0203f3ab5b711d8a56d01b0";
      })
    ];
    buildInputs =
      (self.nativeDeps."nodemailer-direct-transport" or []);
    deps = [
      self.by-version."smtp-connection"."0.1.7"
    ];
    peerDependencies = [
    ];
    passthru.names = [ "nodemailer-direct-transport" ];
  };
  by-spec."nodemailer-smtp-transport"."^0.1.11" =
    self.by-version."nodemailer-smtp-transport"."0.1.12";
  by-version."nodemailer-smtp-transport"."0.1.12" = lib.makeOverridable self.buildNodePackage {
    name = "node-nodemailer-smtp-transport-0.1.12";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/nodemailer-smtp-transport/-/nodemailer-smtp-transport-0.1.12.tgz";
        name = "nodemailer-smtp-transport-0.1.12.tgz";
        sha1 = "d4b5ff9e8308f01e8f63f10f014bda8aa8e21f5e";
      })
    ];
    buildInputs =
      (self.nativeDeps."nodemailer-smtp-transport" or []);
    deps = [
      self.by-version."nodemailer-wellknown"."0.1.2"
      self.by-version."smtp-connection"."0.1.7"
    ];
    peerDependencies = [
    ];
    passthru.names = [ "nodemailer-smtp-transport" ];
  };
  by-spec."nodemailer-stub-transport"."~0.1.4" =
    self.by-version."nodemailer-stub-transport"."0.1.4";
  by-version."nodemailer-stub-transport"."0.1.4" = lib.makeOverridable self.buildNodePackage {
    name = "node-nodemailer-stub-transport-0.1.4";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/nodemailer-stub-transport/-/nodemailer-stub-transport-0.1.4.tgz";
        name = "nodemailer-stub-transport-0.1.4.tgz";
        sha1 = "3d6ad817c6e096381002cc66289fe4088706d8e8";
      })
    ];
    buildInputs =
      (self.nativeDeps."nodemailer-stub-transport" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "nodemailer-stub-transport" ];
  };
  by-spec."nodemailer-wellknown"."^0.1.1" =
    self.by-version."nodemailer-wellknown"."0.1.2";
  by-version."nodemailer-wellknown"."0.1.2" = lib.makeOverridable self.buildNodePackage {
    name = "node-nodemailer-wellknown-0.1.2";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/nodemailer-wellknown/-/nodemailer-wellknown-0.1.2.tgz";
        name = "nodemailer-wellknown-0.1.2.tgz";
        sha1 = "f1f1c4369c6c845f287c162b4ec539bc019a9efc";
      })
    ];
    buildInputs =
      (self.nativeDeps."nodemailer-wellknown" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "nodemailer-wellknown" ];
  };
  ...
  by-spec."pkgcloud"."~0.9.6" =
    self.by-version."pkgcloud"."0.9.6";
  by-version."pkgcloud"."0.9.6" = lib.makeOverridable self.buildNodePackage {
    name = "node-pkgcloud-0.9.6";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/pkgcloud/-/pkgcloud-0.9.6.tgz";
        name = "pkgcloud-0.9.6.tgz";
        sha1 = "44932cd770fe906ec2f4cab4ca3242295e4d6b53";
      })
    ];
    buildInputs =
      (self.nativeDeps."pkgcloud" or []);
    deps = [
      self.by-version."async"."0.1.22"
      self.by-version."errs"."0.2.4"
      self.by-version."eventemitter2"."0.4.14"
  ...
  by-spec."shred"."0.8.10" =
    self.by-version."shred"."0.8.10";
  by-version."shred"."0.8.10" = lib.makeOverridable self.buildNodePackage {
    name = "node-shred-0.8.10";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/shred/-/shred-0.8.10.tgz";
        name = "shred-0.8.10.tgz";
        sha1 = "cf1cfe80f79bf5313d2edc3b912278fd107a8717";
      })
    ];
    buildInputs =
      (self.nativeDeps."shred" or []);
    deps = [
  ...
  by-spec."smtp-connection"."^0.1.5" =
    self.by-version."smtp-connection"."0.1.7";
  by-version."smtp-connection"."0.1.7" = lib.makeOverridable self.buildNodePackage {
    name = "node-smtp-connection-0.1.7";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/smtp-connection/-/smtp-connection-0.1.7.tgz";
        name = "smtp-connection-0.1.7.tgz";
        sha1 = "5de4680a8a4616198ace027279e9a86a9c9d792d";
      })
    ];
    buildInputs =
      (self.nativeDeps."smtp-connection" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "smtp-connection" ];
  };
  by-spec."smtp-connection"."^0.1.7" =
    self.by-version."smtp-connection"."0.1.7";
  by-spec."sntp"."0.2.x" =
    self.by-version."sntp"."0.2.4";
  ...
  by-spec."sprintf"."0.1.1" =
    self.by-version."sprintf"."0.1.1";
  by-version."sprintf"."0.1.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-sprintf-0.1.1";
    src = [
      (fetchurl {
  ...
  by-spec."strong-remoting"."^2.0.0" =
    self.by-version."strong-remoting"."2.0.5";
  by-version."strong-remoting"."2.0.5" = lib.makeOverridable self.buildNodePackage {
    name = "node-strong-remoting-2.0.5";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/strong-remoting/-/strong-remoting-2.0.5.tgz";
        name = "strong-remoting-2.0.5.tgz";
        sha1 = "5729244c28ae84ddb840ff2edeea62dac90b43df";
      })
    ];
    buildInputs =
      (self.nativeDeps."strong-remoting" or []);
    deps = [
      self.by-version."express"."4.8.5"
      self.by-version."body-parser"."1.6.5"
      self.by-version."debug"."1.0.4"
    ...
    passthru.names = [ "strong-remoting" ];
  };
  ...
  by-spec."swagger-client"."2.0.36" =
    self.by-version."swagger-client"."2.0.36";
  by-version."swagger-client"."2.0.36" = lib.makeOverridable self.buildNodePackage {
    name = "node-swagger-client-2.0.36";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/swagger-client/-/swagger-client-2.0.36.tgz";
        name = "swagger-client-2.0.36.tgz";
        sha1 = "4059b3a9749614ec47811f565f5fad921fc78d36";
      })
    ];
    buildInputs =
      (self.nativeDeps."swagger-client" or []);
    deps = [
      self.by-version."shred"."0.8.10"
      self.by-version."btoa"."1.1.1"
    ];
    ...
    passthru.names = [ "swagger-client" ];
  };
  by-spec."swagger-ui"."~2.0.18" =
    self.by-version."swagger-ui"."2.0.22";
  by-version."swagger-ui"."2.0.22" = lib.makeOverridable self.buildNodePackage {
    name = "node-swagger-ui-2.0.22";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/swagger-ui/-/swagger-ui-2.0.22.tgz";
        name = "swagger-ui-2.0.22.tgz";
        sha1 = "716d689c06eed5ef09af7c3c211659fbed545a52";
      })
    ];
    buildInputs =
      (self.nativeDeps."swagger-ui" or []);
    deps = [
      self.by-version."coffee-script"."1.6.3"
      self.by-version."swagger-client"."2.0.36"
      self.by-version."handlebars"."1.0.12"
  ...
  by-spec."toposort"."^0.2.10" =
    self.by-version."toposort"."0.2.10";
  by-version."toposort"."0.2.10" = lib.makeOverridable self.buildNodePackage {
    name = "node-toposort-0.2.10";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/toposort/-/toposort-0.2.10.tgz";
        name = "toposort-0.2.10.tgz";
        sha1 = "bd86f4bb2408307d1912ba6aacbd01790a64fd2c";
      })
    ];
    buildInputs =
      (self.nativeDeps."toposort" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "toposort" ];
  };
  ...
  by-spec."url-join"."0.0.x" =
    self.by-version."url-join"."0.0.1";
  by-version."url-join"."0.0.1" = lib.makeOverridable self.buildNodePackage {
    name = "node-url-join-0.0.1";
    src = [
      (fetchurl {
    ...
    buildInputs =
      (self.nativeDeps."url-join" or []);
    deps = [
    ];
    peerDependencies = [
    ];
    passthru.names = [ "url-join" ];
  };
  ...
  by-spec."xml2js"."0.1.x" =
    self.by-version."xml2js"."0.1.14";
  by-version."xml2js"."0.1.14" = lib.makeOverridable self.buildNodePackage {
    name = "node-xml2js-0.1.14";
    src = [
      (fetchurl {
  ...
  "yargs" = self.by-version."yargs"."1.2.6";
  by-spec."ycssmin".">=1.0.1" =
    self.by-version."ycssmin"."1.0.1";
  by-version."ycssmin"."1.0.1" = lib.makeOverridable self.buildNodePackage {
    name = "ycssmin-1.0.1";
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/ycssmin/-/ycssmin-1.0.1.tgz";
        name = "ycssmin-1.0.1.tgz";
        sha1 = "7cdde8db78cfab00d2901c3b2301e304faf4df16";
      })
    ];
    buildInputs =
      (self.nativeDeps."ycssmin" or []);
    deps = [
    ];
    peerDependencies = [
    ];
