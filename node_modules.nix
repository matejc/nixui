...

{
  ...
  by-spec."domready"."~1.0.5" =
    self.by-version."domready"."1.0.7";
  by-version."domready"."1.0.7" = lib.makeOverridable self.buildNodePackage {
    name = "domready-1.0.7";
    bin = false;
    src = [
      (fetchurl {
        url = "http://registry.npmjs.org/domready/-/domready-1.0.7.tgz";
        name = "domready-1.0.7.tgz";
        sha1 = "539a40bfc2ee46105688268a6c42bf36698d54e3";
      })
    ];
    buildInputs =
  ...
  "domready" = self.by-version."domready"."1.0.7";
  ...
  by-spec."nedb"."~1.0.0" =
    self.by-version."nedb"."1.0.0";
  by-version."nedb"."1.0.0" = lib.makeOverridable self.buildNodePackage {
    name = "nedb-1.0.0";
    bin = false;
    src = [
      (fetchurl {
  ...
  "nedb" = self.by-version."nedb"."1.0.0";
  by-spec."samsam"."~1.1" =
